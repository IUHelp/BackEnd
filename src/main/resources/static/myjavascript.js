               ...
               if (response.linksResult.length == 0){
                        ...
                        for (var i = 0; i < response.linksResult.length; i++) {
                                       ...
                                       if (i==0){
                                                       ...
                                                       console.log(maincontent);
                                            $('<div class="res"><div class="container-fluid"><button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#info">Matching result</button><br><div class="collapse in" id ="info" style="color:#000000"><div>'+maincontent+'</div></div></div><br>').appendTo('#SearchResult');
                                       }
