		...
		success : function(response) {
               ...
               console.log(response.linksResult.length);
                var maincontent = response.textResult;
                 ...
                 $('<div class="container-fluid"><div class="res"><button id="textResult" type="button" /*data-toggle="collapse" data-target="#info"*/ class="btn btn-info">see more</button><br><div class="collapse" id ="info">'+ maincontent+'</div></div></div>').appendTo('#SearchResult');
